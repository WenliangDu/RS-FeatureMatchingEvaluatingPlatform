function [SamplingNumbers,FalseInlierNumber] = Simulation_FalseInliers_Distribution_alpha1_3(Ratio,A_xy_array,DistributionFactor,MeanFactor)
%{
2017/01/10
...
2017/11/22
Simulation_FalseInliers_Distribution_alpha1_3
1. Add MeanFactor
2. Add Simulation_FalseInliers_MeanFactor_alpha1
    Use MeanFactor to shift the most probability outliers distance
%}
if Ratio == 0,
    SamplingNumbers = [];
    FalseInlierNumber = [];
...
PDistriF = Simulation_FalseInliers_MeanFactor_alpha2(PDistriF,MeanFactor); %%% 2017/11/23
