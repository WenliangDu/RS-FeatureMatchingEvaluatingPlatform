...
[ImagePlane_OriginL,ImagePlane_FocalL,WorldPlane_OriginL,WorldPlane_LeftMostL,WorldPlane_RightMostL,...
    WorldPlane_LeftTopL,WorldPlane_LeftBottomL,WorldPlane_RightTopL,WorldPlane_RightBottomL,FocalLengthL,UnitDistanceL,ImagePlane_LeftMostL,ImagePlane_RightMostL] =...
    PushBroom_Simulation_alpha1_8(SlewAngleL,EmissionAngleL,Target,CameraDetail);

[ImagePlane_OriginR,ImagePlane_FocalR,WorldPlane_OriginR,WorldPlane_LeftMostR,WorldPlane_RightMostR,...
    WorldPlane_LeftTopR,WorldPlane_LeftBottomR,WorldPlane_RightTopR,WorldPlane_RightBottomR,FocalLengthR,UnitDistanceR,ImagePlane_LeftMostR,ImagePlane_RightMostR] =...
    PushBroom_Simulation_alpha1_8(SlewAngleR,EmissionAngleR,Target,CameraDetail,Offset);
